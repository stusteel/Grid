...
require.config({
  ...
  paths: {
    ...
    underscore: '../assets/js/libs/lodash.underscore-1.1.1',
    //underscore: '../assets/js/libs/underscore',
    handlebars: "../assets/js/libs/handlebars-1.0.0.beta.6",
    //backbone: "../assets/js/libs/backbone-0.9.2",
    //backbone: "../assets/js/libs/backbone-1.0.0",
    backbone: "../assets/js/libs/backbone", //from marionette download
    //marionette: "../assets/js/libs/backbone.marionette-0.7.0",
    marionette: "../assets/js/libs/backbone.marionette-1.0.2",
    cqrs: "../assets/js/libs/backboneCQRS-0.5.0"
    //cqrs: "../assets/js/libs/backboneCQRS-0.5.5"
  },
